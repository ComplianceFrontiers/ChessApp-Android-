      ...
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
          {!showVideo ? (
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/N_xvwO7KAGM" }}
  ...
  <>
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.background }]}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.goBack("coursedetails/modules/level1/introductionToPieces/38")} // Replace with your actual logic for Previous
        >
          <Text style={styles.buttonText}>Previous</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={styles.navigationButton}
          onPress={() => navigation.navigate("coursedetails/modules/level1/arrangementOfPieces/42")} // Replace with your next screen name
        >

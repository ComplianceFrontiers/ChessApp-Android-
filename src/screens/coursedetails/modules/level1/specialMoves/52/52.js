  ...
  return (
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
          {!showVideo ? (
            ...
            <WebView
              source={{ uri: "https://youtube.com/embed/watch?v=dhlk6bwi4a8" }}
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.background }]}>
        ...
        <TouchableOpacity 
          style={styles.navigationButton}
          onPress={() => navigation.navigate("coursedetails/modules/level1/specialMoves/53")} // Replace with your next screen name
        >

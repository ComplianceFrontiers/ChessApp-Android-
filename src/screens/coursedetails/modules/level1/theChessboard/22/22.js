    ...
    try {
      ...
      if (storedUserDetails) {
        const requestData = {
          ...
          completed: 32, // Update the completion percentage here
        };
        ...
        if (data) { 
          navigation.navigate("coursedetails/modules/level1/theChessboard/23");
        } else {
    ...
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/iYKsprs2yIA" }}
  ...
  ensuring clarity and precision in the game.
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.background }]}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.goBack("coursedetails/modules/level1/theChessboard/23")} // Replace with your actual logic for Previous
        >

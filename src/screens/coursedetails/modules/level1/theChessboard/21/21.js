    ...
    try {
      ...
      if (storedUserDetails) {
        const requestData = {
          ...
          completed: 16, // Update the completion percentage here
        };
        ...
        if (data) { 
          navigation.navigate("coursedetails/modules/level1/theChessboard/22");
        } else {
    ...
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/LlNrGyn8dCY" }}

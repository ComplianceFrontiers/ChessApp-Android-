    ...
    try {
      ...
      if (storedUserDetails) {
        const requestData = {
          ...
          completed: 48, // Update the completion percentage here
        };
        ...
        if (data) { 
          navigation.navigate("coursedetails/modules/level1/theChessboard/24");
        } else {
    ...
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/3sxXQOlorwY" }}
              style={{ width: "90%",
                height: 230,
                alignSelf: "center",

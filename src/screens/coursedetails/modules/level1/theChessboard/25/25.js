    ...
    try {
      ...
      if (storedUserDetails) {
        const requestData = {
          ...
          completed: 80, // Update the completion percentage here
        };
        ...
        if (data) { 
          navigation.navigate("coursedetails/modules/level1/theChessboard/26");
        } else {
    ...
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/YK1C1ANHbdM" }}
  ...
  forward.
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.background }]}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.goBack("coursedetails/modules/level1/theChessboard/24")} // Replace with your actual logic for Previous
        >

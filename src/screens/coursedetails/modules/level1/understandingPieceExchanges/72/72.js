  ...
  const handleNextButtonPress = async () => {
    try {
      ...
      if (storedUserDetails) {
        ...
        if (data) { 
          navigation.navigate("coursedetails/modules/level1/understandingPieceExchanges/73");
        } else {
    ...
    <View style={[styles.mainContain, { backgroundColor: theme.background }]}>
      <ScrollView style={globalStyles.colorBG}>
        <View style={styles.mediaContainer}>
            ...
            <WebView
              source={{ uri: "https://www.youtube.com/embed/watch?v=ajvI0feNzP0" }}
              style={{ width: "90%",
                height: 230,
                alignSelf: "center",
    ...
    <Text style={styles.paragraph}>
      ...
      <View style={[styles.buttonContainer, { backgroundColor: theme.background }]}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.goBack("coursedetails/modules/level1/understandingPieceExchanges/71")} // Replace with your actual logic for Previous
        >
